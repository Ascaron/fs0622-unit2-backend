...
import com.andreacursi.godsfatherpizza.config_bean.Configuration;
import com.andreacursi.godsfatherpizza.config_bean.Drinks;
import com.andreacursi.godsfatherpizza.config_bean.Franchise;
import com.andreacursi.godsfatherpizza.config_bean.Order;
import com.andreacursi.godsfatherpizza.config_bean.Pizza;
import com.andreacursi.godsfatherpizza.config_bean.Toppings;

@SpringBootApplication
public class M2w1d2es2Application {

	public static void main(String[] args) {
		SpringApplication.run(M2w1d2es2Application.class, args);
		System.out.println("");
		System.out.println("");
		menu();
	}
	...
	public static void menu() {
		...
		((AnnotationConfigApplicationContext)ctx).close();
			System.out.println("ORDER n°"+o1.getId()+" "+o1.getState()+" TABLE "+o1.getTable().getId()+" PEOPLE "
					+o1.getPeople()+" PIZZAS "
					+o1.getOrderPizza()+o1.getCoperto());
			List<Integer> cal=new ArrayList<Integer>();
			List<Double> pri=new ArrayList<Double>();
			System.out.println(o1.listDrinksCalories(cal)+" "+o1.listDrinksPrice(pri));
